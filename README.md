WebAuthn Library
=============
[![GoDoc](https://godoc.org/github.com/quexten/webauthn?status.svg)](https://godoc.org/github.com/quexten/webauthn)
![Build Status](https://github.com/quexten/webauthn/workflows/Go/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/quexten/webauthn)](https://goreportcard.com/report/github.com/quexten/webauthn)
...
### Demo at webauthn.io
An implementation of this library can be used at [webauthn.io](https://webauthn.io) and the code for this website can be found in the Duo Labs repository [`webauthn-io`](https://github.com/quexten/webauthn.io).
...
Quickstart
----------
`go get github.com/quexten/webauthn` and initialize it in your application with basic configuration values. 
...
```golang
import "github.com/quexten/webauthn/webauthn"
...
import "github.com/quexten/webauthn/protocol"
import "github.com/quexten/webauthn/webauthn"
